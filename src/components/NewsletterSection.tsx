        ...
        {state === 'done' ? (
          ...
          <form onSubmit={submit} style={{ display: 'flex', gap: 8, marginBottom: 18 }}>
            <input
              ...
              required
              style={{ flex: 1, height: 50, padding: '0 20px', background: 'rgba(255,255,255,0.05)', border: '1px solid var(--ao-nl-t2)', borderRadius: 0, fontFamily: 'inherit', fontSize: 14, color: 'var(--ao-nl-t1)', outline: 'none', transition: 'border-color 0.2s' }}
            />
            <button
              type="submit"
